...
\begin{document}
	...
	\begin{comment} 
	[...] Aquí hablo de las bases de datos
	SAVEE
	RAVDESS
	IEMOCAP
	EMODB
	
	hablar de bases de datos en otros idiomas
	\end{comment}
	...
	Cabe destacar que la combinación de métodos, veáse algoritmos de clasificación, filtros para preprocesar la señal, y métodos de extracción de características, así como distintos conjuntos de datos, es realmente diversa, por lo que visualizar una dirección clara se diluye. No obstante hay observaciones, que pueden llevar a una conclusión general; Por ejemplo, intuitivamente cuanto mayor es el número de clases (emociones en nuestro caso), peor será la capacidad de clasificación de la red, por eso en algunos trabajos se extrae un subconjunto reduciendo las opciones entre las que clasificar.  
	...
	Observamos también que CNN (con diferentes modificaciones) es la opción más sólida entre los trabajos más recientes, debido principalmente a que reduce la señal de audio a sus características más relevantes. La combinación de probabilidades resultantes identifica conjuntos de características que determinan una clasificación.
