...
\begin{document}
	...
	\begin{comment}
		...
		Igual se puede poner una tabla a modo de resumen esquematizado
	\end{comment}
	...
	\begin{comment}
		introduccion a la tabla comentando que se ve, que es un resumen de lo anteriormente descrito
		que algunos textos citados son en realidad una comparación y sólo se expone el que mejor resultado dio (que para eso estamos aqui)
	\end{comment}
	
	\begin{table}[h]
		\begin{center}
			\begin{tabular}{| r | l | c | c| c | c|}
				Autores & Año & Método características & Clasificador & Base de Datos  & Acierto \\ \hline
				Atmaja & 2019 &  & BLSTM + Att & IEMOCAP & 73.34\% 	\\
				J.Wang & 2020 & MFCC & LSTM dual & IEMOCAP & 72.7\% \\
				W.Lim & 2017 &   & LSTM + CNN & EMO-DB &  88.01\%	\\ 
				Harar & 2017 & & CNN & & \\
				& & & & & \\\hline
			\end{tabular}
			\caption{Tabla comparativa de los trabajos mencionados}
